...
## 생성 규칙 (반드시 준수)
1. 지문(passage)은 반드시 중국어(简体字)로만 작성하세요. 한국어 절대 금지.
2. 질문(question)은 반드시 중국어로만 작성하세요. 한국어 절대 금지.
3. 선택지(choices) 4개는 반드시 중국어로만 작성하세요. 한국어 절대 금지.
4. 정답 번호(correct_answer)는 1~4 사이의 정수입니다.
5. 해설(explanation)만 한국어로 작성하세요. 해설에서 지문을 번역하거나 요약하지 말고, 왜 정답인지 이유만 설명하세요.
6. 반드시 아래 JSON 형식으로만 응답하세요. JSON 외 다른 텍스트는 포함하지 마세요.

## 응답 형식 (JSON)
{{
  "passage": "중국어 지문 텍스트 (한국어 금지)",
  "question": "중국어 질문 텍스트 (한국어 금지)",
  "choices": ["중국어 선택지1", "중국어 선택지2", "중국어 선택지3", "중국어 선택지4"],
  "correct_answer": 2,
  "explanation": "한국어 해설 (지문 번역 금지, 정답 이유만 설명)"
}}"""
